  ...
  <tr>
    <td height="851" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center" bgcolor="#999999">Search Result</td>
        </tr>
        <tr>
    ...
    %>
            <tr>
              ...
              <td align="center" valign="middle"><p><%=name %></p>
                ...
                <form id="form6" name="form6" method="post" action="./buy2">
                  <input type="image" name="imageField9" id="imageField9" src="images/buy.png" />
                  <input name="name" type="hidden" id="hiddenField8" value="<%=name %>" />
                </form>
                </td>
            </tr>
          <%} %>
