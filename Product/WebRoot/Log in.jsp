...
<table width="1344" height="855" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="851" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="21" align="center" bgcolor="#999999">Log in </td>
        </tr>
        <tr>
          <td height="21" align="center" bgcolor="#FFFFFF">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF"><form id="form2" name="form2" method="post" action="./login">
            <table width="763" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="763" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="380" align="right" bgcolor="#999999">username　:　</td>
                    <td width="383" bgcolor="#999999"><label for="username"></label>
              ...
              <tr>
                <td><table width="763" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="380" align="right" bgcolor="#999999">password　:　</td>
                    <td width="383" bgcolor="#999999"><label for="username"></label>
              ...
              <tr>
                <td height="40" align="center" valign="bottom" bgcolor="#FFFFFF"><input type="image" name="imageField7" id="imageField7" src="images/submit.png" /></td>
              </tr>
            </table>
          </form></td>
        </tr>
