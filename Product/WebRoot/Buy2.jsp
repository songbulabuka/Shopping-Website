  ...
  <tr>
    <td height="851" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td bgcolor="#CCCCCC">Products that going to buy:</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
    ...
    picture2 = rb.getPicture2();
        ...
        <tr>
          <td align="center" bgcolor="#CCCCCC"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <td width="35%"><img src="<%=picture0 %>" width="380" height="430" /></td>
              <td align="center"><table width="60%" border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="72%">Product Name :</td>
                  <td><%=name %></td>
                  </tr>
                <tr>
                  <td>Price :</td>
        ...
        <tr>
          <td align="right" bgcolor="#CCCCCC">Total : $<%=price %></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td bgcolor="#339966">Delivery Message:</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#999999"><form id="form2" name="form2" method="post" action="./directbuy">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="50%"><label for="textfield"></label>
                      <input type="text" name="telephone" id="textfield" />
                      <input type="hidden" name="name"  id="hiddenField2" value="<%=name %>" /></td>                      
                  </tr>
                </table></td>
              </tr>
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td>Address :</td>
                    <td width="50%"><label for="textfield2"></label>
                      <input type="text" name="address" id="textfield2" /></td>
                                           
                  </tr>
                </table></td>
              </tr>
              <tr>             
                <td align="center"><input type="image" name="imageField7" id="imageField7" src="images/submit.png" /></td>
              </tr>
            </table>
          </form></td>
        </tr>
