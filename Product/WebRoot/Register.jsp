...
<table width="1344" height="855" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td height="851" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="21" align="center" bgcolor="#999999">Register</td>
        </tr>
        <tr>
          <td height="21" align="center" bgcolor="#FFFFFF">&nbsp;</td>
        </tr>
        <tr>
          <td align="center"><form id="form2" name="form2" method="post" action="./register">
            <table width="50%" border="0" cellspacing="1" cellpadding="0">
              <tr>
                <td width="200" align="right" bgcolor="#999999">username :　</td>
                <td width="200" bgcolor="#999999"><label for="username1"></label>
                  <input type="text" name="username1" id="username1" /></td>
              </tr>
              <tr>
                <td align="right" bgcolor="#999999">password :　</td>
                <td bgcolor="#999999"><label for="password1"></label>
                  <input type="password" name="password1" id="password1" /></td>
              </tr>
              <tr>
                <td align="right" bgcolor="#999999">password again　:　</td>
                <td bgcolor="#999999"><label for="password2"></label>
                  <input type="password" name="password2" id="password2" /></td>
              </tr>
            </table>
            <p>
              <input type="image" name="imageField7" id="imageField7" src="images/submit.png" />
            </p>
          </form>            
          <p>&nbsp;</p></td>
        </tr>
