   	...
   	<% ArrayList<Shopping> ar=new ArrayList<Shopping>();
   	 ...
   	 for(int i=0;i<ar.size();i++){
   	    shop.setProduct(ar.get(i).getProduct());
   	 	...
   	 	%>
            <tr>
              <td width="35%"><img src="<%=shop.getPicture() %>" width="380" height="430" /></td>
              <td align="center"><table width="60%" border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="72%">Product Name :</td>
                  <td><%=shop.getProduct()%></td>
                  </tr>
                <tr>
                  <td>Price :</td>
                  <td>$<%=shop.getPrice() %></td>
                  </tr>
                 <% total=total+Integer.parseInt(shop.getPrice());%>
                <tr>
                  <td>Num :</td>
                  <td>1</td>
                </tr>
        ...
        <tr>
          <td align="center" bgcolor="#999999"><form id="form2" name="form2" method="post" action="./addorder">
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="50%"><label for="textfield"></label>
                      <input type="text" name="telephone" id="textfield" /></td>
                  </tr>
                </table></td>
              </tr>
              <tr>
