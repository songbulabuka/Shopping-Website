  ...
  <tr>
    <td height="851" align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="21" align="center" bgcolor="#666666">About us</td>
        </tr>
        <tr>
          <td><p>&nbsp;</p></td>
        </tr>
        <tr>
          <td align="center"><table width="80%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td bgcolor="#999999"><p>Our company: Hikeeper is a company that makes robots for home smart and entertainment. It was founded in 2017 solited in Beijing, China.</p>
                <p>Our team: We are a team that is keen on robot design and research and development full of ideas, ambitions and passion for the future.</p></td>
            </tr>
          </table></td>
        </tr>
        <tr>
